...

{
	...
	KinectAzure.K4ABT_TRACKER_PROCESSING_MODE_GPU_CUDA = 2;     /**< SDK will use ONNX Cuda EP to run the tracker */
  KinectAzure.K4ABT_TRACKER_PROCESSING_MODE_GPU_TENSORRT = 3; /**< SDK will use ONNX TensorRT EP to run the tracker */
  KinectAzure.K4ABT_TRACKER_PROCESSING_MODE_GPU_DIRECTML = 4 /**< SDK will use ONNX DirectML EP to run the tracker (Windows only) */
}
